	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Bike Model/Manufacturer</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">View/Edit/Delete - Bike Manufacturer & Model </h2>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-xs-6">
				<div class="panel panel-default">
					<div class="panel-heading">Bike Manufacturer</div>
			...
			<div class="col-xs-6">
				<div class="panel panel-default">
					<div class="panel-heading">Bike Model</div>
					<div class="panel-body">
