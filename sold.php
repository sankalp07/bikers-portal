...
<?php $res=mysqli_query($con,"SELECT * FROM customer JOIN vehicle ON customer.v_id=vehicle.v_id JOIN users ON vehicle.u_id=users.u_id;");
?>
 ...
 <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
     <div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">View Sold Bikes</li>
			</ol>
	</div><!--/.row-->
	...
	<div class="modal fade" id="insert" role="dialog" aria-labelledby="insert" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title custom_align" id="Heading">Add New Bike</h4>
				</div>
					...
					<div class="row">
						...
						<label>Bike Category</label>
							<select class="form-control" name="category" required>
							  ...
							  <option value="Mini-Van">Sports Bike</option>
							</select>
						</div>
						<div class="col-xs-6">
						<br>
		...
		<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Sold Bikes</h2>
			</div>
			 <!-- add new vehicle  button -->
		</div><!--/.row-->
		
		<div style="padding-left: 25%">
		<div style="display:inline">Sold Bike Filter</div>
