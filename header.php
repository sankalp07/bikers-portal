...
$ut=mysqli_query($con,"SELECT COUNT(*) FROM users;");
//$ucount=mysqli_result($ut);

$vt=mysqli_query($con,"SELECT COUNT(*) FROM customer;");
//$vcount=mysql_result($vt);
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="dashboard.php">Admin Area</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<a class="nav menu" href="#">
                    <img src="https://images-na.ssl-images-amazon.com/images/I/51EvhrdaPuL.jpg" alt="" height="200" width="180" style="margin-left: 9%; margin-top: 3%; "></a>
		<br></div>
  ...
  ?>
			<li><a href="model.php"><svg class="glyph stroked dashboard dial"><use xlink:href="#stroked-dashboard-dial"/></svg>Bike Model</a></li>
			<li><a href="vehicles.php"><svg class="glyph stroked table"><use xlink:href="#stroked-table"></use></svg>Bikes</a></li>
			<li><a href="sold.php"><svg class="glyph stroked calendar"><use xlink:href="#stroked-calendar"></use></svg>Sold Bikes</a></li>
