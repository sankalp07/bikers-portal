...
try
{
	...
	else if($_GET["action"] == "checkuser")
	{
				if(!empty($_POST["username"])) {
				  $result = mysqli_query($con,"SELECT count(*) FROM users WHERE u_email='" . $_POST["username"] . "'");
					...
					<form role="form">
						<div class="row">
							...
							<div class="form-group">
							  <label>Bike ID</label><input type="text" class="form-control" value="'.$vehicleRow['v_id'].'" disabled>
							</div></div>
							<div class="col-xs-6">
							<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-xs-6">
							<div class="form-group">
							  <label>Bike Category</label><input type="text" class="form-control" value="'.$vehicleRow['category'].'" disabled>
							</div></div></div>
						<div class="row">
							<div class="col-xs-6">	
							<div class="form-group">
							  <label>Bike Buying Price</label><input type="text" class="form-control" value="'.$vehicleRow['b_price'].'" disabled>
							</div></div>
							<div class="col-xs-6">	
							<div class="form-group">
							  <label>Bike Selling Price</label><input type="text" class="form-control" value="'.$vehicleRow['s_price'].'" disabled>
							</div></div></div>
						<div class="row">
							<div class="col-xs-6">		
							<div class="form-group">
