...
{	
	...
	if(mysqli_query($con,"INSERT INTO users (u_mobile,s_ans,s_question,u_gender,u_pass,u_address,f_name,l_name,u_bday,u_position,u_type,u_email)VALUES('$u_mobile','$s_ans','$s_question','$u_gender','$u_pass','$u_address','$f_name','$l_name','$u_bday','$u_position','$u_type','$u_email')"))
		{
			?>
							...
							<div class="form-group">
								Security Question : 
									<select class="form-control" placeholder="Security Question" name="s_question">
										  ...
										  <option value="Who do you prise?">Who do you like?</option>
									</select>
							</div>
							<div class="form-group">
